...
>>> orange = machine.Pin(3, machine.Pin.OUT)
...
\begin{frame}[fragile]
	...
	MicroPython uses \emph{physical pins} of the ESP8266, not the \emph{mapped pins} (\texttt{D0}) of the Wemos.
	\begin{columns}[t]
	...
	\begin{columns}[t]
		\begin{column}{{2\textwidth}/3}
			\begin{itemize}
				...
				\item (Not that exciting to implement the driver...)
			\end{itemize}
			\begin{minted}
	[
		frame=lines,
