...
\begin{frame}
    \begin{figure}
        \includegraphics[width=\textwidth]{ex_imgs/1.png}
        \caption{Create and checkout 'fizzbuzz' feature branch}
    \end{figure}
\end{frame}
\begin{frame}
    \begin{figure}
        \includegraphics[width=\textwidth]{ex_imgs/2.png}
        \caption{Make some commits}
    \end{figure}
\end{frame}
\begin{frame}
    \begin{figure}
        \includegraphics[width=\textwidth]{ex_imgs/3.png}
        \caption{Commits on feature branch, no other branches}
    \end{figure}
\end{frame}
\begin{frame}
    \begin{figure}
        \includegraphics[width=\textwidth]{ex_imgs/4.png}
        \caption{Legal team makes new branch from master, makes changes}
    \end{figure}
\end{frame}
\begin{frame}
    \begin{figure}
        \includegraphics[width=\textwidth]{ex_imgs/5.png}
        \caption{We add another commit}
    \end{figure}
\end{frame}
\begin{frame}
    \begin{figure}
        \includegraphics[width=\textwidth-2cm]{ex_imgs/6.png}
        \caption{Merge legal change to master}
    \end{figure}
\end{frame}
\begin{frame}
    \begin{figure}
        \includegraphics[width=\textwidth]{ex_imgs/7.png}
        \caption{Merge fizzbuzz -- lucky, no conflicts!}
    \end{figure}
\end{frame}
\begin{frame}
    \begin{figure}
        \includegraphics[width=\textwidth]{ex_imgs/8.png}
